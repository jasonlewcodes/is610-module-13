...
def test_calculator_add(page, fastapi_server):
    ...
    # Wait for the result to appear (allowing time for the async fetch to complete)
...
def test_calculator_divide_by_zero(page, fastapi_server):
    ...
    # Wait for the error message to appear (allowing time for the async fetch to complete)
